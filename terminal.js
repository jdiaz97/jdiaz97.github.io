...
var cmd_list = [];
var cmd_index = 0;
var available_cmd = ["about", "education", "projects", "experience", "skills", "contact", "get-resume", "help", "clear"];
...
document.addEventListener('click', function() {
    cmd.focus();  // Re-focus the input field whenever the user clicks anywhere on the page
});
